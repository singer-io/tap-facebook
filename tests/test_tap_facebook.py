...
class TestAdsInsights(unittest.TestCase):
    def test_insights_start_dates(self):
        ...
        self.assertEqual(
            params[0]["time_ranges"], [{"since": "2017-01-03", "until": "2017-01-03"}]
        )

        self.assertEqual(
            params[4]["time_ranges"], [{"since": "2017-01-07", "until": "2017-01-07"}]
        )
    ...
    def test_insights_job_params_stops(self):
        ...
        insights = AdsInsights(
            ...
            state={
                "bookmarks": {"insights": {"date_start": start_date.to_date_string()}}
            },
        )
...
class TestPrimaryKeyInclusion(unittest.TestCase):
    def test_primary_keys_automatically_included(self):
        ...
        for catalog_entry in catalog:
            streamObject = [
                stream for stream in streams if stream.name == catalog_entry["stream"]
            ][0]
